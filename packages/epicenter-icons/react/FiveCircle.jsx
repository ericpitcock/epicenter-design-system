export const FiveCircle = (props) => (
  <svg
    ...
    {...props}
  >
    <path d="M9 15C9 15 9.5 17 12 17C13.6569 17 15 15.7949 15 14C15 12.2051 13.6569 11 12 11C10.3431 11 9 12 9 12L10 7H15" strokeLinecap="round" strokeLinejoin="round" />
