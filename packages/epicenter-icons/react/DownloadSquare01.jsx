export const DownloadSquare01 = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
  ...
  >
    ...
    <path d="M16 12.5L12 16.5L8 12.5M12 15.5V7.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

DownloadSquare01.displayName = 'DownloadSquare01';
