export const CloudLittleRain = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
    ...
    {...props}
  >
    <path d="M12.0011 13.5V15M9 16.5V18M15 16.5V18M6.5 19.5V21M17.5 19.5V21M12 19.5V21" strokeLinecap="round" strokeLinejoin="round" />
...
CloudLittleRain.displayName = 'CloudLittleRain';
