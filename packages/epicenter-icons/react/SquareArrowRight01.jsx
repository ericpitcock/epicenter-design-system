export const SquareArrowRight01 = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
  ...
  >
    ...
    <path d="M10 7.5L14 12L10 16.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

SquareArrowRight01.displayName = 'SquareArrowRight01';
