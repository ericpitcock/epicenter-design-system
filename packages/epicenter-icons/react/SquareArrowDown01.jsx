export const SquareArrowDown01 = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
  ...
  >
    ...
    <path d="M16.5 10L12 14L7.5 10" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

SquareArrowDown01.displayName = 'SquareArrowDown01';
