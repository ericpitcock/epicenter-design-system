export const LaptopRemove = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
  ...
  >
    ...
    <path d="M10 8L12 10M12 10L14 12M12 10L14 8M12 10L10 12" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

LaptopRemove.displayName = 'LaptopRemove';
