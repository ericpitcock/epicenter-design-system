export const FileSync = (props) => (
  ...
  >
    ...
    <path d="M11 16L12 18C12.2426 16.3039 13.7368 15 15.5 15C16.6894 15 17.7402 15.5933 18.3726 16.5M20 21L19 19C18.7574 20.6961 17.2632 22 15.5 22C14.3106 22 13.2598 21.4067 12.6273 20.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
