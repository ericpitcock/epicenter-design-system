export const SquareArrowLeft02 = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
    ...
    {...props}
  >
    <path d="M10.5 14.5L8 12.0004L10.5 9.5" strokeLinecap="round" strokeLinejoin="round" />
...
SquareArrowLeft02.displayName = 'SquareArrowLeft02';
