...
const SevenCircle = (props) => (
  <svg
    ...
    {...props}
  >
    <path d="M9 7H14.584C14.8138 7 15 7.18625 15 7.41599C15 7.47144 14.9889 7.52632 14.9674 7.57742L11 17" strokeLinecap="round" strokeLinejoin="round" />
