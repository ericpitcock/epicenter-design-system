export const VkSquare = (props) => (
  ...
  >
    ...
    <path d="M12 8V16C6.5 14 6.5 8 6.5 8M17.5 8C17.5 8 16 11.5 12 12C16 12.5 17.5 16 17.5 16" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

VkSquare.displayName = 'VkSquare';
