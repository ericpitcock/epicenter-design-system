export const Layout04 = (props) => (
  <svg
    ...
    {...props}
  >
    <path d="M9 2.5V21.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M9 12.5H21.5" strokeLinecap="round" strokeLinejoin="round" />
