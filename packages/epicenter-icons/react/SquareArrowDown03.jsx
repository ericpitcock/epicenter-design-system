export const SquareArrowDown03 = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
  ...
  >
    ...
    <path d="M12 14L12 7M12 14L14.5 11.5M12 14L9.5 11.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

SquareArrowDown03.displayName = 'SquareArrowDown03';
