export const SquareArrowUpRight02 = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
    ...
    {...props}
  >
    <path d="M15 9L8 16M10 8H16V14" strokeLinecap="round" strokeLinejoin="round" />
...
SquareArrowUpRight02.displayName = 'SquareArrowUpRight02';
