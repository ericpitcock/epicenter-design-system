...
const TimeHalfPass = (props) => (
  ...
  >
    ...
    <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2" strokeLinecap="round" />
    <path d="M12 13.5C12.8284 13.5 13.5 12.8284 13.5 12C13.5 11.1716 12.8284 10.5 12 10.5M12 13.5C11.1716 13.5 10.5 12.8284 10.5 12C10.5 11.1716 11.1716 10.5 12 10.5M12 13.5V16M12 10.5V6" strokeLinecap="round" />
  </svg>
);

TimeHalfPass.displayName = 'TimeHalfPass';
