export const Navigation01 = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
  ...
  >
    ...
    <path d="M14.0004 12.0085C14.0004 13.114 13.1049 14.0102 12.0002 14.0102C10.8955 14.0102 10 13.114 10 12.0085C10 10.903 10.8955 10.0068 12.0002 10.0068C13.1049 10.0068 14.0004 10.903 14.0004 12.0085Z" />
  </svg>
);

Navigation01.displayName = 'Navigation01';
