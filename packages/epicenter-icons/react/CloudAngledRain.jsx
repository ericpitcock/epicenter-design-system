export const CloudAngledRain = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
    ...
    {...props}
  >
    <path d="M12.5 15L11.5 17M17 15L16 17M13.5 19L12.5 21M8 15L7 17M9 19L8 21" strokeLinecap="round" strokeLinejoin="round" />
...
CloudAngledRain.displayName = 'CloudAngledRain';
