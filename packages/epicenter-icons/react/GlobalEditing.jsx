...
const GlobalEditing = (props) => (
  <svg
    ...
    {...props}
  >
    <path d="M14 19.5V22H16.5L22 16.5L19.5 14L14 19.5Z" strokeLinejoin="round" />
    <path d="M22 12.0247C22 6.48823 17.5228 2 12 2C6.47715 2 2 6.48823 2 12.0247C2 17.2229 5.94668 21.497 11 22" strokeLinecap="round" strokeLinejoin="round" />
...
GlobalEditing.displayName = 'GlobalEditing';
