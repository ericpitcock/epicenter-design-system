export const SquareArrowLeft01 = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
  ...
  >
    ...
    <path d="M14 7.5L10 12L14 16.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

SquareArrowLeft01.displayName = 'SquareArrowLeft01';
