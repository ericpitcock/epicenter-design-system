export const CheckmarkSquare02 = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
  ...
  >
    ...
    <path d="M8.5 12.5L11 15L16 9" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

CheckmarkSquare02.displayName = 'CheckmarkSquare02';
