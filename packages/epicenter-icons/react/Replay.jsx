export const Replay = (props) => (
  ...
  >
    ...
    <path d="M10.9961 15.1451C10.3295 15.526 9.5 15.0446 9.5 14.2768V9.72318C9.5 8.95536 10.3295 8.47399 10.9961 8.85494L14.9806 11.1318C15.6524 11.5157 15.6524 12.4843 14.9806 12.8682L10.9961 15.1451Z" strokeLinejoin="round" />
  </svg>
);
