export const Cupcake01 = (props) => (
  <svg
    ...
    {...props}
  >
    <path d="M18 12L16.7562 20.2965C16.6094 21.2756 15.7683 22 14.7783 22H9.15985C8.19742 22 7.37147 21.3145 7.19411 20.3686L6 14" strokeLinejoin="round" />
...
Cupcake01.displayName = 'Cupcake01';
