export const Briefcase03 = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
  ...
  >
    ...
    <path d="M10 12.5V14.5C10 15.0523 10.4477 15.5 11 15.5H13C13.5523 15.5 14 15.0523 14 14.5V12.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

Briefcase03.displayName = 'Briefcase03';
