...
const ParkingAreaSquare = (props) => (
  ...
  >
    ...
    <path d="M8.5 12.5V6.5H12.5C14.1569 6.5 15.5 7.84315 15.5 9.5C15.5 11.1569 14.1569 12.5 12.5 12.5H8.5ZM8.5 12.5V17.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
