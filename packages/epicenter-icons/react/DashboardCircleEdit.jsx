...
const DashboardCircleEdit = (props) => (
  <svg
    className="ep-icon"
    viewBox="0 0 24 24"
    aria-hidden="true"
  ...
  >
    ...
    <path d="M20.8536 4.43934L19.5607 3.14645C19.3654 2.95118 19.0489 2.95118 18.8536 3.14645L14.5 7.5L14 10L16.5 9.5L20.8536 5.14645C21.0489 4.95118 21.0489 4.6346 20.8536 4.43934Z" strokeLinejoin="round" />
  </svg>
);

DashboardCircleEdit.displayName = 'DashboardCircleEdit';
