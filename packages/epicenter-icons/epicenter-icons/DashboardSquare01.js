...
const _hoisted1 = h('path', { 'd': 'M9.5 3H4C3.44772 3 3 3.44772 3 4V9.5C3 10.0523 3.44772 10.5 4 10.5H9.5C10.0523 10.5 10.5 10.0523 10.5 9.5V4C10.5 3.44772 10.0523 3 9.5 3Z', 'stroke-linejoin': 'round' })
const _hoisted2 = h('path', { 'd': 'M20 3H14.5C13.9477 3 13.5 3.44772 13.5 4V9.5C13.5 10.0523 13.9477 10.5 14.5 10.5H20C20.5523 10.5 21 10.0523 21 9.5V4C21 3.44772 20.5523 3 20 3Z', 'stroke-linejoin': 'round' })
