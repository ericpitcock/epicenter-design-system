...
const _hoisted2 = h('path', { 'd': 'M8 7H16', 'stroke-linecap': 'round', 'stroke-linejoin': 'round' })
const _hoisted3 = h('path', { 'd': 'M12 10L12 17M12 10L14.5 12.5M12 10L9.5 12.5', 'stroke-linecap': 'round', 'stroke-linejoin': 'round' })
