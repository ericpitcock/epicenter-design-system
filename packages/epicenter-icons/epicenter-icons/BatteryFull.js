...
const _hoisted3 = h('path', { 'd': 'M6 10V14', 'stroke-linecap': 'round' })
const _hoisted4 = h('path', { 'd': 'M9 10V14', 'stroke-linecap': 'round' })
const _hoisted5 = h('path', { 'd': 'M12 10V14', 'stroke-linecap': 'round' })
const _hoisted6 = h('path', { 'd': 'M15 10V14', 'stroke-linecap': 'round' })
