...
const _hoisted1 = h('path', { 'd': 'M2.5 7.5V12.5M2.5 21.5H19.5C20.6046 21.5 21.5 20.6046 21.5 19.5V7.5', 'stroke-linecap': 'round', 'stroke-linejoin': 'round' })
...
const _hoisted5 = h('path', { 'd': 'M2.5 15.5H5.5M2.5 18.5H8.5', 'stroke-linecap': 'round', 'stroke-linejoin': 'round' })
