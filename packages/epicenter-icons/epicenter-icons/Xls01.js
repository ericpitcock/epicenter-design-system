...
const _hoisted1 = h('path', { 'd': 'M10.5 16V22H14', 'stroke-linecap': 'round', 'stroke-linejoin': 'round' })
const _hoisted2 = h('path', { 'd': 'M4 16L6 19M6 19L8 22M6 19L8 16M6 19L4 22', 'stroke-linecap': 'round', 'stroke-linejoin': 'round' })
const _hoisted3 = h('path', { 'd': 'M20.0002 16H16.5V19H20.0002V22H16.5', 'stroke-linecap': 'round', 'stroke-linejoin': 'round' })
