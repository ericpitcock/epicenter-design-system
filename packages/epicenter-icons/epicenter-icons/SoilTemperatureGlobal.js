...
const _hoisted1 = h('path', { 'd': 'M19 22C20.6569 22 22 20.6569 22 19C22 17.8896 21.3967 16.9201 20.5 16.4013V13.5C20.5 12.6716 19.8284 12 19 12C18.1716 12 17.5 12.6716 17.5 13.5V16.4013C16.6033 16.9201 16 17.8896 16 19C16 20.6569 17.3431 22 19 22Z', 'stroke-linecap': 'round', 'stroke-linejoin': 'round' })
const _hoisted2 = h('path', { 'd': 'M13 18C13 17.5 13.5 16.5 14 16', 'stroke-linecap': 'round', 'stroke-linejoin': 'round' })
