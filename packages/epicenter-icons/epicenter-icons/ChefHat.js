...
const _hoisted2 = h('path', { 'd': 'M18 12V20M6 12V20', 'stroke-linecap': 'round', 'stroke-linejoin': 'round' })
const _hoisted3 = h('path', { 'd': 'M6 17.5C7.59905 16.8776 9.69952 16.5 12 16.5C14.3005 16.5 16.401 16.8776 18 17.5', 'stroke-linecap': 'round' })
const _hoisted4 = h('path', { 'd': 'M5 21C6.86556 20.3776 9.3161 20 12 20C14.6839 20 17.1344 20.3776 19 21', 'stroke-linecap': 'round' })
