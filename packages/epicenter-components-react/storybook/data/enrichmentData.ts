...
const generateFakeVirusTotal = (ip: string) => ({
  name: 'VirusTotal',
  data: {
    'IP Address': ip,
...
const generateFakeAbuseIPDB = (ip: string) => ({
  name: 'AbuseIPDB',
  data: {
    'IP Address': ip,
...
const generateFakeIPInfo = (ip: string) => ({
  name: 'IPInfo.io',
  data: {
    'IP Address': ip,
...
const generateFakeGreyNoise = (ip: string) => ({
  name: 'GreyNoise',
  data: {
    'IP Address': ip,
...
const generateFakeShodan = (ip: string) => ({
  name: 'Shodan',
  data: {
    'IP Address': ip,
...
const generateFakePassiveTotal = (domain: string) => ({
...
const generateFakeWHOIS = (domain: string) => ({
  name: 'WHOIS',
  data: {
    'Domain': domain,
    'Registrar': faker.company.name(),
...
const generateFakeGoogleSafeBrowsing = (url: string) => ({
...
const generateFakeURLhaus = (url: string) => ({
  name: 'URLhaus',
  data: {
    'URL': url,
...
const generateFakeMACVendor = (mac: string) => ({
...
export const getFakeEnrichmentResponse = (property: string, value: string): Record<string, unknown> => {
  switch (property) {
    case 'IP Address':
    case 'XFF IP Address':
    case 'DNS Resource Data':
      return {
