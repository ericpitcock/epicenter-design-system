    ...
    >
      <defs>
        <style>{`
          .logo-polygon,
          .logo-path {
            stroke: var(--logo-stroke-color, hsl(var(--gray-500)));
            stroke-width: var(--logo-stroke-width, 3);
            stroke-linejoin: round;
            stroke-miterlimit: 5;
          }
          .logo-shadow {
            fill: var(--logo-shadow-color, hsl(var(--gray-500)));
          }
          .logo-highlight {
            fill: var(--logo-hightlight-color, hsl(var(--gray-0)));
          }
          .logo-face {
            fill: var(--logo-face-color, #fff16c);
          }
        `}</style>
      </defs>
      <path
        className="logo-path logo-shadow"
      ...
      />
      <polygon
        className="logo-polygon logo-highlight"
        points="48.31 169.24 77.31 1.5 28.45 61.12 1.5 195.34 48.31 169.24"
      />
      <polygon
        className="logo-polygon logo-face"
