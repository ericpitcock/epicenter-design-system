...
|------|-------------|------|---------|
| `colors` | Array of color values to randomly assign.
Colors are coordinated across all instances to avoid repeats
until all colors have been used (bag randomization). | `Array` | `-` |

## Slots
| Name | Description |
|------|-------------|
| `default` | Default slot. Content inherits the randomly assigned color. |
